...
| `design-system.json` | Sistem dizini (başlık, kütüphaneler, varlık grupları). Yalnızca tasarım sistemi artifact'ine geri yüklerken gerekir. **Logo listesi 1.0 ailesini yansıtır ve eskimiştir**; `blob` kimlikleri artifact deposuna ait olduğu için elle üretilemez, sistem yeniden dışa aktarıldığında tazelenir. |
